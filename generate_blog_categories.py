...
/* Blog cards only — do not alter the category page shell */
.article-list{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:28px}
.article-list .blog-card{max-width:340px;width:100%;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 10px rgba(0,0,0,.08);text-decoration:none;color:inherit;display:block;padding:0;box-sizing:border-box}
.article-list .blog-card .article-card-image{width:100%;height:220px;object-fit:cover;display:block;margin:0}
.article-list .blog-card .blog-card-body{padding:18px 20px 20px}
.article-list .blog-card .blog-card-title{font-size:19px;font-weight:700;line-height:1.35;margin:0 0 10px;color:#111}
.article-list .blog-card .blog-card-excerpt{font-size:14px;line-height:1.6;margin:0 0 14px;color:#6b6b6b}
.article-list .blog-card .blog-card-link{display:inline-block;font-size:14px;font-weight:700;color:#111;text-decoration:underline}
@media(max-width:900px){.article-list{grid-template-columns:repeat(2,minmax(0,1fr));gap:20px}.article-list .blog-card .article-card-image{height:220px}}
@media(max-width:650px){.article-list{grid-template-columns:1fr;gap:18px}.article-list .blog-card{max-width:340px;margin:0 auto}.article-list .blog-card .article-card-image{height:220px}}
</style>'''
